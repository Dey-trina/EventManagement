...
<div class="panel-body">
    <div class="row">
        <div class="col-lg-20">
                  {!!Form::open(['url'=>'/photography/addphotography','method'=>'post','enctype'=>'multipart/form-data','role'=>'form'])!!}
                ...
                <div class="form-group">
                                      <label>Photography Cost</label>
                                           <input type="number" class="form-control" name="pprice" placeholder="Per Photo">
                                                 </div>
