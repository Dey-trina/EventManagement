...
<div class="panel-body">
    <div class="row">
        <div class="col-lg-20">
                        ...
                        {!!Form::open(['url'=>'/light/edit','method'=>'post','enctype'=>'multipart/form-data','name'=>'lightEditForm'])!!} 
          ...
          <div class="form-group">
                       ...
                       <div class="form-group">
                                      <label>Light Name</label>
                                           <input type="text" class="form-control" name="name" value="{{$light->lightName}}" >
                                                 </div>
                ...
                <div class="form-group">
                                      <label>Cost</label>
                                           <input type="number" class="form-control" name="price" value="{{$light->cost}}">
                                                 </div>

  <div class="form-group">
                                      <label>Light Image</label>
                                           <input type="file" name="image" value="{{$light->lightImage}}">
...
" />
                                  ...
                                  <script type="text/javascript">
                                   document.forms['lightEditForm'].elements['eventType'].value='{{$light->eventType}}'
