...
<div class="panel-body">
   ...
   Total Item: {{$sounds->total()}} <br>
    ...
    <!--<form action="/food/search" method="get">-->
         {!!Form::open(['url'=>'/sound/search','method'=>'get','role'=>'form'])!!}
                            ...
                            <table width="80%" border="1" align="center" class="table table-striped table-bordered table-hover" id="dataTables-example" >
                                ...
                                <tbody>
                                	...
                                	<tr>
                                		...
                                		<td align="center"><a href="{{ url('sound/user_view/'. $sound->user_id.'/'.$sound->soundCompanyName )}}" target="___blank"> View</a> </td>
